            ...
            <div class="relative flex items-top justify-center min-h-screen dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
                <div class="mx-auto sm:px-6 lg:px-8 w-full">
                    @auth
                        <x-dashboard />
                    @else
                        <section class="text-center h-screen w-full relative flex content-center flex-col items-center justify-center">
                            ...
                            <div class="flex items-center mt-10">
                                <x-nav-link href="/docs">Documentation</x-nav-link>
                                <div class="py-1 px-3 font-bold border-2 cursor-pointer border-black ml-10 rounded duration-150 hover:bg-black hover:text-white">
                                    Download
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="mt-16 w-full">
                            <div class="flex w-full justify-between">
                                <div class="home-example">
                                    ...
                                    <pre class="p-3 w-full bg-white border mt-4 border-gray-400 rounded snowball-lang">
    ...
    <span class="k">fn</span> <span class="ty">getSound</span>(): <span class="k">String</span> => <span class="mi">self</span>.sound;
                            ...
                            <div class="mt-5">
                                <div class="home-example w-full flex">
                                    ...
                                    <pre class="p-3 w-full bg-white border mt-4 border-gray-400 rounded snowball-lang min-w-[400px] ml-10">
<span class="k">fn</span> <span class="ty">fib</span>(n: <span class="k">i64</span> = <span class="ty">47</span>) <span class="k">i64</span> {
    ...
    <span class="k">return</span> <span class="ty">fib</span>(n-<span class="ty">1</span>) + <span class="ty">fib</span>(n-<span class="ty">2</span>);
                            ...
                            <div class="w-full p-2 px-5 bg-cyan-200 my-5 border-2 border-black rounded-lg flex content-center justify-between">
